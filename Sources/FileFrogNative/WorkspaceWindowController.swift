...
final class WorkspaceWindowController: NSWindowController {
    ...
    private func buildUI() {
        ...
        sidebar.addSubview(label("最近投喂", size: 15, weight: .semibold))
    ...
    private func layoutSidebar(_ sidebar: NSView) {
        guard let title = sidebar.subviews.first as? NSTextField,
        ...
        NSLayoutConstraint.activate([
            ...
            title.topAnchor.constraint(equalTo: sidebar.topAnchor, constant: 18),
    ...
    private func layoutRightPanel(_ panel: NSView) {
        guard panel.subviews.count == 4,
              let overview = panel.subviews[0] as? NSScrollView,
              let title = panel.subviews[1] as? NSTextField,
              let questions = panel.subviews[2] as? NSStackView,
              let answer = panel.subviews[3] as? NSScrollView else { return }
        title.translatesAutoresizingMaskIntoConstraints = false
        ...
        NSLayoutConstraint.activate([
            ...
            title.topAnchor.constraint(equalTo: overview.bottomAnchor, constant: 14),
